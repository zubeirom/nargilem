  ...
  return (
    <footer className="px-4 divide-y dark:bg-coolGray-800 dark:text-coolGray-100">
      <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
        ...
        <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-1">
              <li>
                <a href="#">+49 800 00075 50</a>
              </li>
              <li>
                <a href="#">Kontaktformular</a>
              </li>
              <li>
                <a href="#">Versand und Zahlungsbedingung</a>
              </li>
              <li>
          ...
          <div className="space-y-4">
            <h3 className="uppercase dark:text-coolGray-50">Infos</h3>
            <ul className="space-y-1">
              <li>
                <a href="#">Newsletter</a>
              </li>
      ...
      <div className="py-6 text-sm text-center dark:text-coolGray-400">
        © 2016 Nargilem GmbH. Alle Rechte vorbehalten.
      </div>
    </footer>
  )
}
